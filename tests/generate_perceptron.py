...
from projqube.projectq.setups.decompositions import *
...
def generate_instructions():
    ...
    eng = projectq.MainEngine(backend=OpenSurgeryExporter(output = "perceptron_instructions"), engine_list=engines, verbose=False)
